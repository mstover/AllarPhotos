...
public class FineArtSearchResultsViewer extends SearchResultsViewer {
	...
	public FineArtSearchResultsViewer(String[][] selectedValues, String familyName) {
		this.numToShow = 30;
		family = familyName;
	...
	protected Widget getWelcomeScreen() {
		Label bookmark_tag = AjaxSystem.getText("Please ensure that all bookmarks go " +
				"to http://fineart.scanbank.com","bookmarkAlert");
		Label instructions = AjaxSystem
				.getText("Please begin your search by selecting a folder under Browse Image Libraries. " +
	...
	protected void initControls() {
		numberToShowClick = new ClickListener() {
			 ...
			 */
		// displayNumSelect =
		// (NumberSelector)Services.getServices().factory.createComponent("NumberSelector",new
		// Object[]{new int[]{5,30,100},numberToShowClick,new
		// Integer(numToShow)});
		/*
