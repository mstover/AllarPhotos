...
public class PavilionSearchResultsViewer extends SearchResultsViewer {

	protected Label categoryShown;

	public PavilionSearchResultsViewer(String[][] selectedValues, String familyName) {
		this.numToShow = 30;
		family = familyName;
	...
	protected Widget getWelcomeScreen() {
		Label bookmark_tag = AjaxSystem.getText("Please ensure that all bookmarks go " +
				"to http://pavilion.scanbank.com","bookmarkAlert");
