...
<%--
	...
	**************************************************************/
    ...
    if(groups.length<1) 
    {
		response.sendRedirect("/lazerweb/zXZx-LIBRARY-xZXz/index.jsp?relogin=true"); // ALERT UPON TIMEOUT
    }else if((groups[0].equals("zXZx-LIBRARY-xZXz_Dept") )){ // && security.getPermission("zXZx-LIBRARY-xZXz_User",Resource.GROUP,Rights.ADMIN))){
...
%><%--
	...
	**************************************************************/
	...
	{
		if(secureCheck[i].equals("admin") || secureCheck[i].equals("zXZx-LIBRARY-xZXz_Admin")) 
		{
