...
public class FineArtMenu extends LazerMenu {
	protected boolean addBrowseMenu = true;

	public FineArtMenu(boolean vertical, CommandFactory c) {
		super(vertical, c);
		// TODO Auto-generated constructor stub
	}

	public FineArtMenu(CommandFactory c) {
		super(c);
		// TODO Auto-generated constructor stub
	}

	protected void addLeftHeader(CommandFactory cmd) {
		Image logo = new Image("fineart/images/fineart_logo.gif");
	...
	*/
	...
	protected void addSupportFormLink(CommandFactory cmd) {
		...
		item.setTitle("User Tips for FineArt Library.");
		mainBar.addItem(item);
	}
