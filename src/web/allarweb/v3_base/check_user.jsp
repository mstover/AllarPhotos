...
<tr valign="TOP"><td align="center" colspan="2"><form action="edit_user_info.jsp"><input border="0" type="submit" value="Edit User Information"></form></td></tr>
</table>
<laz:if object="$_cart" method="hasInstruction" arguments="ordering">
	...
	<input type="submit" name="submit" value="Submit New Address">
	</form>
</laz:if>
<form action="verify.jsp"><input type="submit" border="0" value="Continue with Checkout"></form>
</div>
