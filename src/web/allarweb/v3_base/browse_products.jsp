    ...
    <DIV ALIGN="center">
      ...
      <c:if test="${productsFound.numberPages > 1}">
        ...
        <tr valign="middle">
                ...
                <INPUT TYPE="submit" NAME="previous" VALUE="Previous" align="absmiddle">
                </form>
						</c:when>
						<c:otherwise>
							&nbsp;
					...
					<c:choose>
						<c:when test="${productsFound.displaySet + 1 < productsFound.numberPages}">
							<FORM ACTION="browse_products.jsp" METHOD="POST">
								<INPUT TYPE="Hidden" NAME="request_browse_set"
									VALUE='<c:out value="${productsFound.displaySet + 1}" />'>
								<INPUT TYPE="submit" NAME="next" VALUE="Next" align="absmiddle">
							</form>
						</c:when>
						<c:otherwise>
							&nbsp;
      ...
      <c:forEach var="currentProduct" varStatus="counter" items="${productsFound.displayProducts}">
        ...
        <td align="center" class="small1" height='150' width='150'>
				<form action="browse_products.jsp" method="POST">
					...
					<laz:ifBlock object="$_cart" method="hasProduct" arguments="$_currentProduct"> 
						<laz:if>
							...
							<input type="submit" align="top" align="absmiddle" name="submit" value="Remove from Cart" border=0>
						</laz:if>
						<laz:else>
							...
							<input type="submit" align="top" align="absmiddle" name="submit" value="Add to Cart" border=0>
						</laz:else>	
					</laz:ifBlock>
				</form>
        </td>
