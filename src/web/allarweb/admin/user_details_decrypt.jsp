...
<TR><th>First Name</th><th>Last Name</th><TH>Username</TH><TH><a href="users.jsp?page=user_details&source_group=<%=URLEncoder.encode(groupChoice)%>">Password</a></TH><TH>Company</TH><th>Referrer</th></TR>
<%
	for(int x = 0;x < userList.length;x++)
	{
		%><TR VALIGN="TOP">
				...
				<TD><%=userList[x]%></TD>
				<TD><%=admin.getUser(userList[x]).getPassword()%></TD>
