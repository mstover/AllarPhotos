...
public class FineArtNumberSelector extends NumberSelector {
	...
	public FineArtNumberSelector() {
		// TODO Auto-generated constructor stub
	}

	public FineArtNumberSelector(int[] series, ClickListener cl, int sv) {
		super(series, cl, sv);
		// TODO Auto-generated constructor stub
	}

	public FineArtNumberSelector(int numCells, int start, int end, ClickListener cl,
			int sv) {
