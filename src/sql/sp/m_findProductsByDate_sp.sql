...
CREATE OR ALTER PROCEDURE m_findProductsByDate (table_name VARCHAR(25),keyword_value VARCHAR(32))
...
grant execute on procedure m_findProductsByDate to damuser;
