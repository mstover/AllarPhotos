...
public class PavilionNumberSelector extends NumberSelector {
	...
	public PavilionNumberSelector() {
		// TODO Auto-generated constructor stub
	}

	public PavilionNumberSelector(int[] series, ClickListener cl, int sv) {
		super(series, cl, sv);
		// TODO Auto-generated constructor stub
	}

	public PavilionNumberSelector(int numCells, int start, int end, ClickListener cl,
			int sv) {
