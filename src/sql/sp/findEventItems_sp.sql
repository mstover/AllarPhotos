...
CREATE OR ALTER PROCEDURE findEventItems (action_name VARCHAR(252),category_name VARCHAR(50),category_value VARCHAR(252),dateCol VARCHAR(32))
...
grant execute on procedure findEventItems to damuser;
